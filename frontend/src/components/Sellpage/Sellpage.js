                            ...
                            <div class="left-content">
                                <div class="thumb">
                                    <div class="inner-content">
                                        <h4 style={{color:"wheat"}}>Shale on Upstage Commerce </h4>
                                        <span style={{color:"wheat"}}>20 crore+ customers across India trust Upstage to be their number 1 online shopping destination. It is no surprise that more
                                            than a million sellers trust their products to be made available 24x7 on Upstage</span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="right-first-image">
                                            <div class="thumb">
                                                <div class="inner-content">
                                                    <h4 style={{color:"wheat"}}>Women</h4>
                                                    <span style={{color:"wheat"}}>Best Clothes For Women</span>
                                                </div>
                                                <div class="hover-content">
                                                    <div class="inner">
                                                        <h4 style={{color:"wheat"}}>Women</h4>
                                                        <p style={{color:"wheat"}}>Showcase a wide range of women's dresses, categorized by style, occasion, size, and color.</p>
                                                        <div class="main-border-button">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="right-first-image">
                                            <div class="thumb">
                                                <div class="inner-content">
                                                    <h4 style={{color:"wheat"}}>Men</h4>
                                                    <span style={{color:"wheat"}}>Best Clothes For Men</span>
                                                </div>
                                                <div class="hover-content">
                                                    <div class="inner">
                                                        <h4 style={{color:"wheat"}}>Men</h4>
                                                        <p style={{color:"wheat"}}> Showcase a wide range of men's clothing and accessories, categorized by type (e.g., shirts, pants, shoes) and style.</p>
                                                        <div class="main-border-button">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="right-first-image">
                                            <div class="thumb">
                                                <div class="inner-content">
                                                    <h4 style={{color:"wheat"}}>Kids</h4>
                                                    <span style={{color:"wheat"}}>Best Clothes For Kids</span>
                                                </div>
                                                <div class="hover-content">
                                                    <div class="inner">
                                                        <h4 style={{color:"wheat"}}>Kids</h4>
                                                        <p style={{color:"wheat"}}>Showcase a wide range of children's clothing, toys, accessories, and other kids' products, organized by age group and category.</p>
                                                        <div class="main-border-button">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="right-first-image">
                                            <div class="thumb">
                                                <div class="inner-content">
                                                    <h4 style={{color:"wheat"}}> Accessories</h4>
                                                    <span style={{color:"wheat"}}>Best Trend Accessories</span>
                                                </div>
                                                <div class="hover-content">
                                                    <div class="inner">
                                                        <h4 style={{color:"wheat"}}>Accessories</h4>
                                                        <p style={{color:"wheat"}}>Organize accessories by categories (e.g., jewelry, bags, scarves, hats, sunglasses).
