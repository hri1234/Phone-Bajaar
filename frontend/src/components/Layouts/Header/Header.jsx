      ...
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        {/* <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          ...
          {isAuthenticated === false ?
            <Link to="/login" className="px-3 sm:px-9 py-0.5 text-primary-blue bg-white border font-medium rounded-sm cursor-pointer" style={{color:"#000"}}>Login</Link>
            :
            (
          ...
          <span className="moreDropDown hidden sm:flex items-center text-white font-medium gap-1 cursor-pointer" onClick={() => setToggleSecondaryDropDown(!toggleSecondaryDropDown)} style={{color:"#000"}}>More
          ...
          <Link to="/cart" className="flex items-center text-white font-medium gap-2 relative" style={{color:"#000"}}>
            <span><ShoppingCartIcon /></span>
            {cartItems.length > 0 &&
              <div className="w-5 h-5 p-2 bg-red-500 text-xs rounded-full absolute -top-2 left-3 flex justify-center items-center border" style={{color:"#000"}}>
                {cartItems.length}
              </div>
            }
            Cart
